...
<p><img alt="DeepG logo" height="70px" src="man/figures/logo_small.png" align="left" hspace="10px" vspace="0px"></p>

<h1><b>DeepG: R toolbox for deep neural networks optimized for genomic datasets</b></h1>
