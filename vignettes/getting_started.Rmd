...
The goal of the deepG package is to speed up the development of biofinformatical tools for sequence classification, homology detection and other bioinformatical tasks. 
...
We can now evaluate the trained model on the validation data
