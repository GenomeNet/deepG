...
The set of allowed character in a sequence. What happens with characters outside the vocabulary can be controlled with
...
Exampels for language models follow in the next section.
