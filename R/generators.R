...
generator_fasta_label_folder <- function(path_corpus,
  ...
  function() {
    ...
    x_1 <- 4096*x_1[,1:(dim(x)[2]-6)]+1024*x_1[,2:(dim(x)[2]-5)]+256*x_1[,3:(dim(x)[2]-4)]+64*x_1[,4:(dim(x)[2]-3)]+16*x_1[,5:(dim(x)[2]-2)]+4*x_1[,6:(dim(x)[2]-1)]+x_1[,7:(dim(x)[2])]+1
    x_2 <- array(0,dim=c(dim(x_1)[1], 4096*4,1))
